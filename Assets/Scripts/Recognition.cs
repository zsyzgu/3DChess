...
class Recognition : MonoBehaviour
{
    void Start()
    {
        Mat rawImg1 = Cv2.ImRead("img1.png", ImreadModes.Color);
        Mat rawImg2 = Cv2.ImRead("img2.png", ImreadModes.Color);
        ...
        Mat imgDesc1 = new Mat();
        Mat imgDesc2 = new Mat();
        surf.Compute(img1, ref keyPoints1, imgDesc1);
        surf.Compute(img2, ref keyPoints2, imgDesc2);*/
